...
public:
	...
	virtual void createReaderForQueue(std::shared_ptr<IBoostWrapper> boostWrapper, int socketNumber) = 0;
	virtual void createWriterForQueue(std::shared_ptr<IBoostWrapper> boostWrapper, int socketNumber) = 0;
	virtual std::shared_ptr<std::thread> startReader() = 0;
	virtual std::shared_ptr<std::thread> startWriter() = 0;
